...
// files, arranged for use in CrasheeObjC.

#ifndef HDR_CrasheeObjCApple_h
#define HDR_CrasheeObjCApple_h
...
// Crashee: The original values wouldn't have worked. The slot shift and mask
// were incorrect.
#define TAG_COUNT 8
